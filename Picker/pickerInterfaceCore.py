...
from Picker.Core import thumbnail
from Picker.Core import viewerWidget3 as viewerWidget
from Picker.Core import sceneWidget3 as sceneWidget
from Picker.Core import graphicsItemWidget
from Picker.Core import pixmapWidget2 as pixmapWidget
reload(thumbnail)
reload(viewerWidget)
reload(sceneWidget)
